  ...
  return (
    <View style={[stylesGeneral.container, {justifyContent: 'flex-start'}]}>
      ...
      <View style={stylesHasil.identitasContainer}>
        <Text style={stylesHasil.identitasText}>Nama pasien : Zeke Yeager</Text>
      ...
      <View style={stylesHasil.obatContainer}>
        ...
        <DataTable
          ...
          <DataTable.Row>
            ...
            <DataTable.Cell style={stylesHasil.centerBorder}>1</DataTable.Cell>
          </DataTable.Row>
          <DataTable.Row
            style={[
      ...
      <Text style={stylesHasil.pemberitahuan}>
        Untuk bisa melihat hasil ini lagi kamu bisa tangkap layar ini atau kamu
        bisa melihatnya di riwayat di menu diatas
      </Text>
    </View>
  );
};
